...
OpTrigonometriceClass::OpTrigonometriceClass(Client *client, QWidget *parent)
	: QWidget(parent)
{
	CLIENT = client;
	ui.setupUi(this);
...
OpTrigonometriceClass::~OpTrigonometriceClass()
{
}

void OpTrigonometriceClass::button()
{
	string Send = ui.send_mess->text().toStdString();
	string result = "(OperatiiTrigonometrice)" + Send;
