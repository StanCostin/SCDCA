...
EcGradICONClass::EcGradICONClass(Client *client, QWidget *parent)
	: QWidget(parent)
{
	CLIENT = client;
	ui.setupUi(this);
...
EcGradICONClass::~EcGradICONClass()
{
}

void EcGradICONClass::button()
{
	string Send = ui.send_mess->text().toStdString();
	string result = "(EcGradICuONecunoscuta)" + Send;
