...
ARCCOTANGENTAClass::ARCCOTANGENTAClass(Client *client, QWidget *parent)
	: QWidget(parent)
{
	CLIENT = client;
	ui.setupUi(this);
...
ARCCOTANGENTAClass::~ARCCOTANGENTAClass()
{
}

void ARCCOTANGENTAClass::button()
{
	string Send = ui.send_mess->text().toStdString();
	string result = "(Arcctg)" + Send;
