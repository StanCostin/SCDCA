...
EcGradIFGClass::EcGradIFGClass(Client *client, QWidget *parent)
	: QWidget(parent)
{
	CLIENT = client;
	ui.setupUi(this);
...
EcGradIFGClass::~EcGradIFGClass()
{
}

void EcGradIFGClass::button()
{
	string Send = ui.send_mess->text().toStdString();
	string result = "(EcGradIFormaGenerala)" + Send;
