...
AranjamenteClass::AranjamenteClass(Client *client, QWidget *parent)
	: QWidget(parent)
{
	CLIENT = client;
	ui.setupUi(this);
...
AranjamenteClass::~AranjamenteClass()
{
}

void AranjamenteClass::button()
{
	string Send = ui.send_mess->text().toStdString();
	string result = "(Aranjamente)" + Send;
